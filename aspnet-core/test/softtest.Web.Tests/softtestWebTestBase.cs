...
{
    public abstract class softtestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static softtestWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(softtestWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<softtestDbContext> action)
        {
            using (var context = IocManager.Resolve<softtestDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<softtestDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<softtestDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<softtestDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<softtestDbContext, Task<T>> func)
        {
            T result;
